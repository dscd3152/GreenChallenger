...
public class RewardAdActivity extends AppCompatActivity {
    ...
    private void rewardUser(String uid, String today) {
        ...
        db.runTransaction(transaction -> {
                    ...
                    int newGrowthStage = GrowthPolicy.getGrowthStage(newPoints);
                ...
                .addOnSuccessListener(watchedCount -> {
                    txtAdStatus.setText("광고 시청 완료! +" + AD_REWARD_POINTS + "P 지급");
    ...
    private void updateAdStatusText(int watchedCount) {
        ...
        if (remainCount <= 0) {
            txtAdStatus.setText("오늘 광고 보상을 모두 받았습니다.\n내일 다시 참여해주세요.");
            btnWatchAd.setEnabled(false);
        } else {
            txtAdStatus.setText("광고 시청 시 +" + AD_REWARD_POINTS + "P\n오늘 남은 횟수: " + remainCount + "회");
